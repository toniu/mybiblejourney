            ...
            <div className='container max-w-[1240px] text-center m-auto'>
                <ul className='flex justify-center text-3xl'>
                    <li className='nav-item p-4'>
                        <a href="https://www.instagram.com/mybiblejourneyig" target="_blank" rel="noopener noreferrer"
                            className="mx-8
                    ...
                    <li className='nav-item p-4'>
                        <a href="https://www.tiktok.com/@mybiblejourneytt" target="_blank" rel="noopener noreferrer"
                            className="mx-8
                            hover:text-yellow-200 transition 100">
                            <FaTiktok/>
                        </a>
